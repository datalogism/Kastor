...
python ./src/train_withShape_withObj.py model=bart_base_model data=DS_turtleS_0datatype_1inLine_1facto_bart_train_writtenwork_abs_clean train=bart_dbpedia