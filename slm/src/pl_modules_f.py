...
from score import re_score_withShapeWithObj, re_score_withShapeWithObjText2KG,re_score_withShapeWithObjandFilter
...
class BasePLModule(pl.LightningModule):
    ...
    def on_validation_epoch_end(self) -> Any:
        ...
        if(self.obj_ext):
            ...
            scores, part_parsed, part_subj_ok, part_valid_s, part_valid_r, callbacks = re_score_withShapeWithObjandFilter(pred_list,
                                                                                                          gold_list,
                                                                                                          syntax,
                                                                                                          syntax_conf,
                                                                                                          self.shapes,
