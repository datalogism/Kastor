...
class KFoldDataModule(LightningDataModule):
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        print("============================ HERE BEGIN TRAIN INDEX")
        print(train_fold.indices)
        print("============================ HERE END TRAIN INDEX")
    ...
    def test_dataloader(self) -> DataLoader:
        ...
        print("============================ HERE BEGIN TEST INDEX")
        print(test_fold.indices)
        print("============================ HERE END TEST INDEX")
