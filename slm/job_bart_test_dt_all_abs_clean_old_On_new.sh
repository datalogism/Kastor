...
#
#### JOB INFO
#SBATCH --job-name=DS_turtleS_0datatype_1inLine_1facto_bart_test_obj_and_dt_prop_abs_clean_old_ON_new
#SBATCH --output=DS_turtleS_0datatype_1inLine_1facto_bart_test_obj_and_dt_prop_abs_clean_old_ON_new.txt
###### CONF
#SBATCH --ntasks=1
#SBATCH --nodes=1
