...
### B1. KR0
**Input:** a set $Seed_{data}$ $n$ entities and prefined the number $N$ of synthetic examples that must be generated, and distilled Knowledge base  $\mathcal{K}_{distill.}(s^*)$   <br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; get the associated graph-text couple $(g_i,t_i)$ associated to $e_i$ in $\mathcal{K}_{distill.}(s^*)$ <br>
...
4. Initialise the set of the synthetic example $Synth_data$
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Create a template $t_i$ from $w_i$ the abstract associated to $e_i$ in $\mathcal{K}_{distill.}(s^*)$ <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Fill the template $t_i$ with the data of $g_j$ the graph associated to $e_j$ in $\mathcal{K}_{distill.}(s^*)$ this new abstract is named $\hat{w_j}$  <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Add $(e_i,e_j,g_j,\hat{w_j})$ in $Synth_{data}$ <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Create a template $t_j$ from $w_j$ the abstract associated to $e_j$ in $\mathcal{K}_{distill.}(s^*)$ <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Fill the template $t_j$ with the data of $g_i$ the graph associated to $e_i$ in $\mathcal{K}_{distill.}(s^*)$ this new abstract is named $\hat{w_i}$  <br>
