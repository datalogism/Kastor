...
if __name__ == '__main__':
    ...
    parser.add_argument("-wgroup", "--wandb_group", default=None)
    parser.add_argument("-output", "--dir_save", default=None)
    args = parser.parse_args()

    if args.wandb_api_key and args.wandb_user and args.wandb_project and args.wandb_group and args.dir_save:
        api = wandb.Api()
        ...
        group=args.wandb_group # here the model must be a test done a on RD dataset with a model M
        ...
        for dir_ in dirs:
            ...
            ### Two columns dedicated to annotation
            df["verif"]=None
            df["reason"] = None
